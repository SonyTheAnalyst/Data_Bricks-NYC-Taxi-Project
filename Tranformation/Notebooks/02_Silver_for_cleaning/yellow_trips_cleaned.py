...
df = df.filter(
    "tpep_pickup_datetime >= '2025-06-01' AND tpep_pickup_datetime < '2025-11-01'" 
)
...
df.write.mode('overwrite').saveAsTable('nyctaxi.`02_silver`.yellow_trip_cleansed')
spark.read.table('nyctaxi.`02_silver`.yellow_trip_cleansed').display()