...
df_trips = spark.read.table("/Workspace/Shared/NYC_TAXY_FOLDER/Tranformation/Notebooks/02_Silver_for_cleaning/(Clone) yellow_trips_cleansed").filter(f"tpep_pickup_datetime > '{two_months_ago_start}'")
