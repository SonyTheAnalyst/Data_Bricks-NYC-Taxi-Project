...
df_trips = spark.read.table('nyctaxi.`02_silver`.yellow_trip_cleansed')
...
df_join_final.write.mode('overwrite').saveAsTable('nyctaxi.`02_silver`.yelllow_trips_enriched')
spark.read.table('nyctaxi.`02_silver`.yelllow_trips_enriched').display()